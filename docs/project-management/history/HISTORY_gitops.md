...
### 산출물
- 브랜치 `feat/w3-observability-backlog`, PR #\<PR>. `prometheus-rules.yaml`·`grafana-dashboard-apps.yaml`·`nipio/grafana-ingress.yaml`·`bring-up.sh`(observability apply)·WORKFLOW_W3 Step 8.
